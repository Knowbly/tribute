...
var TributeEvents = function () {
    ...
    _createClass(TributeEvents, [{
        ...
        value: function bind(element, editor) {
            ...
            element.addEventListener('keypress', element.boundKeypress, false);
        ...
        value: function unbind(element) {
            ...
            element.removeEventListener('keypress', element.boundKeypress, false);
        ...
        key: 'keypress',
        value: function keypress(instance, editor, event) {
            if (editor) {
                TributeEvents.removeMention(editor, event);
            }
        }
        ...
        key: 'removeMention',
        value: function removeMention(editor, event) {
            var charCode = typeof event.which === "undefined" ? event.keyCode : event.which;
            var anchor = editor.selection.get().anchorNode;
            if (TributeEvents.isInsideMention(anchor)) {
